...
{
	public int screwState;

	public int loop;

	public void Start()
	{
		crewAnimations = new string[10] { "idle", "idle_a", "idle_b", "idle_c", "idle_d", "right_screwdriver_a_start", "right_screwdriver_a_mid", "right_screwdriver_a_end", "wkC_forward01", "wkC_run01" };
