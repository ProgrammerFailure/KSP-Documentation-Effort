...
public static class SimplexNoise
{
	...
	public static int gi0;

	public static int gi1;

	public static int gi2;

	public static int gi3;
	...
	public static double itr;

	public static double total;

	public static double amplitude;

	public static double maxAmplitude;
	...
	public static void SetupPermTable()
	{
		perm = new int[512];
		for (int i = 0; i < 512; i++)
		{
	...
	public static double noise(Vector3d v3d)
	{
		return noise(v3d.x, v3d.y, v3d.z);
	}

	public static double noise(double octaves, double persistence, double frequency, double x, double y, double z)
	{
		total = 0.0;
		amplitude = 1.0;
		maxAmplitude = 0.0;
	...
	public static double noise(double octaves, double persistence, double frequency, Vector3d v3d)
	{
		return noise(octaves, persistence, frequency, v3d.x, v3d.y, v3d.z);
	}
}
