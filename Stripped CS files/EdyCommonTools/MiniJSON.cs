...
public class MiniJSON
{
	...
	public static string lastDecode = "";
	...
	public static Hashtable parseObject(char[] json, ref int index)
	{
	...
	public static ArrayList parseArray(char[] json, ref int index)
	{
	...
	public static double parseNumber(char[] json, ref int index)
	{
		eatWhitespace(json, ref index);
	...
	public static bool serializeObjectOrArray(object objectOrArray, StringBuilder builder)
	{
	...
	public static bool serializeDictionary(Dictionary<string, string> dict, StringBuilder builder)
	{
		builder.Append("{");
		bool flag = true;
	...
	public static bool serializeArray(ArrayList anArray, StringBuilder builder)
	{
		builder.Append("[");
		bool flag = true;
		int num = 0;
	...
	public static void serializeNumber(double number, StringBuilder builder)
	{
