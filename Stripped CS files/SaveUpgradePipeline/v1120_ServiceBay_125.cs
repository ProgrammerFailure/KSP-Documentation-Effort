...
public class v1120_ServiceBay_125 : PartReplace
{
	public override string Description => "Replaces the old Service Bay (1.25m) for the new Service Bay (1.25m).";

	public override Version EarliestCompatibleVersion => new Version(0, 21, 0);

	public override string Name => "1.12 Service Bay (1.25m) replacement";
	...
	{
		pName = "ServiceBay.125";
		replacementPartName = "ServiceBay.125.v2";
		refTransformName = "ServiceBay.125.v2";
