...
public class v170_fuelTank1_2 : PartReplace
{
	public override string Description => "Replaces the old Rockomax X200-32 Fuel Tank for the new one.";

	public override Version EarliestCompatibleVersion => new Version(0, 21, 0);

	public override string Name => "1.7 Rockomax X200-32 replace";
	...
	{
		pName = "fuelTank1-2";
		replacementPartName = "Rockomax32.BW";
		refTransformName = "Rockomax32.BW";
