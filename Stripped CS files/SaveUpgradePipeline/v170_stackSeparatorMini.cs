...
public class v170_stackSeparatorMini : PartReplace
{
	public override string Description => "Replaces the old TR-2C Stack Separator for the TS-06 Separator.";

	public override Version EarliestCompatibleVersion => new Version(0, 21, 0);

	public override string Name => "1.7 TR-2C replace";
	...
	{
		pName = "stackSeparatorMini";
		replacementPartName = "Separator.0";
		refTransformName = "Separator.0";
