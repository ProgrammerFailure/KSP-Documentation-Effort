...
public class v1120_probeCoreOcto : PartReplace
{
	public override string Description => "Replaces the old Probodobodyne OKTO for the new Probodobodyne OKTO.";

	public override Version EarliestCompatibleVersion => new Version(0, 21, 0);

	public override string Name => "1.12 Probodobodyne OKTO replacement";
	...
	{
		pName = "probeCoreOcto";
		replacementPartName = "probeCoreOcto.v2";
		refTransformName = "probeCoreOcto.v2";
