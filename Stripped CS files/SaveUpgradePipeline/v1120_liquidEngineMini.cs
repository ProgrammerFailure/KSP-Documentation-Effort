...
public class v1120_liquidEngineMini : PartReplace
{
	public override string Description => "Replaces the old 48-7S Spark Liquid Fuel Engine for the new 48-7S Spark Liquid Fuel Engine.";

	public override Version EarliestCompatibleVersion => new Version(0, 21, 0);

	public override string Name => "1.12 48-7S Spark Liquid Fuel Engine replacement";
	...
	{
		pName = "liquidEngineMini";
		replacementPartName = "liquidEngineMini.v2";
		refTransformName = "liquidEngineMini.v2";
		posOffset = new Vector3(0f, 0f, 0f);
		rotOffset = Quaternion.identity;
		att0Offset = new Vector3(0f, 0f, 0f);
		childPosOffset = new Vector3(0f, -0.025f, 0f);
		attNOffsets = new List<attachNodeOffset>
		{
			...
			{
				id = "bottom",
				offset = new Vector3(0f, -0.025f, 0f)
			}
		};
	}
