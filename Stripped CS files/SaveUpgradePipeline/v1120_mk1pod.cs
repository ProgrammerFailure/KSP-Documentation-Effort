...
{
	public override string Description => "Replaces the old Mk1 Command Pod for the new Mk1 Command Pod.";

	public override Version EarliestCompatibleVersion => new Version(0, 21, 0);

	public override string Name => "1.12 Mk1 Command Pod replacement";
	...
	{
		pName = "mk1pod";
		replacementPartName = "mk1pod.v2";
		refTransformName = "mk1pod.v2";
