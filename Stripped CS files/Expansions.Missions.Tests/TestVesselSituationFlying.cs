...
public class TestVesselSituationFlying : TestVesselSituation, IScoreableObjective, INodeWaypoint, ITestNodeLabel, INodeBody
{
	...
	[MEGUI_ParameterSwitchCompound(order = 10, excludeParamFields = "biomeData,areaData,anyData,launchsiteName", guiName = "#autoLOC_8000149")]
	...
	public override void Awake()
	{
		...
		title = Localizer.Format("#autoLOC_8000180");
	...
	{
		return Localizer.Format("#autoLOC_8004015");
	}
}
