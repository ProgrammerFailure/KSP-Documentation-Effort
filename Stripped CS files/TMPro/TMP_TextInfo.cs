...
{
	public static Vector2 k_InfinityVectorPositive = new Vector2(32767f, 32767f);

	public static Vector2 k_InfinityVectorNegative = new Vector2(-32767f, -32767f);
	...
	public void ClearUnusedVertices(MaterialReference[] materials)
	{
		for (int i = 0; i < meshInfo.Length; i++)
		{
			meshInfo[i].ClearUnusedVertices(0);
		}
	}
