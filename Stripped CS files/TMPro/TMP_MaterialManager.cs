...
public static class TMP_MaterialManager
{
	...
	public static void OnPreRenderCanvas()
	{
		if (isFallbackListDirty)
		{
			CleanupFallbackMaterials();
	...
	public static Material GetStencilMaterial(Material baseMaterial, int stencilID)
	{
		...
		while (true)
		{
			...
			{
				if (m_materialList[num].baseMaterial.GetInstanceID() == instanceID && m_materialList[num].stencilID == stencilID)
				{
					break;
				}
				num++;
		...
		return m_materialList[num].stencilMaterial;
	}
