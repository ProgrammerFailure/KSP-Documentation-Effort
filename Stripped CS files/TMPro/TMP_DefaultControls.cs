...
public static class TMP_DefaultControls
{
	...
	public static Vector2 s_ThickElementSize = new Vector2(160f, 30f);

	public static Vector2 s_ThinElementSize = new Vector2(160f, 20f);

	public static Color s_DefaultSelectableColor = new Color(1f, 1f, 1f, 1f);

	public static Color s_TextColor = new Color(10f / 51f, 10f / 51f, 10f / 51f, 1f);
