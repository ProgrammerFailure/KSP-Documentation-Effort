...
public class CameraController : MonoBehaviour
{
	...
	public const string event_SmoothingValue = "Slider - Smoothing Value";

	public const string event_FollowDistance = "Slider - Camera Zoom";
