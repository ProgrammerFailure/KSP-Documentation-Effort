...
public class TMP_TextSelector_B : MonoBehaviour, IPointerEnterHandler, IEventSystemHandler, IPointerExitHandler, IPointerClickHandler, IPointerUpHandler
{
	...
	public const string k_LinkText = "You have selected link <#ffff00>";

	public const string k_WordText = "Word Index: <#ffff00>";
	...
	public TMP_MeshInfo[] m_cachedMeshInfoVertexData;
	...
	public void RestoreCachedVertexAttributes(int index)
	{
