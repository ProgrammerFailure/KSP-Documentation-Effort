...
public class TMP_UiFrameRateCounter : MonoBehaviour
{
	...
	public const string fpsLabel = "{0:2}</color> <#8080ff>FPS \n<#FF8000>{1:2} <#8080ff>MS";

	public TextMeshProUGUI m_TextMeshPro;

	public RectTransform m_frameCounter_transform;

	public FpsCounterAnchorPositions last_AnchorPosition;
